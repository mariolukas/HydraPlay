...
var Peer = function (_EventEmitter) {
  ...
  function Peer(onMessage) {
    ...
    _this2._asyncEmitError = process.nextTick.bind(process, _this2.emit.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2))), 'error');
  ...
  _proto.notify = function () {
    ...
    return function notify(_x3, _x4) {
