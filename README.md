...
```
:warning: **Building on an Apple silicon requires [Rosetta](https://docs.docker.com/desktop/mac/apple-silicon/) and you need to enable platform: linux/amd64 in the docker-compose.yml file.**: 
